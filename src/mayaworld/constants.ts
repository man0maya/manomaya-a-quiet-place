...
export const ACTION_DEFS: ActionDef[] = [
  ...
  { id: 'bathe', label: 'Bathe', tileTypes: ['river', 'lake', 'water', 'beach'], description: 'Cleanse in the sacred water', karmaEffect: 2 },
  { id: 'plant', label: 'Plant', tileTypes: ['garden', 'grove', 'clearing', 'flower', 'grass'], description: 'Return something to the earth', karmaEffect: 3 },
  { id: 'observe_sky', label: 'Watch Sky', tileTypes: ['mountain', 'clearing', 'beach', 'sand', 'stone_path'], description: 'Lift your eyes and observe', karmaEffect: 2 },
  { id: 'read_ruins', label: 'Read Ruins', tileTypes: ['ruins', 'temple', 'cave'], description: 'Trace the ancient markings', karmaEffect: 2 },
  { id: 'serve', label: 'Serve', tileTypes: ['grass', 'clearing', 'temple', 'shrine', 'grove', 'hut', 'village', 'garden', 'flower', 'forest', 'tall_grass', 'sand', 'beach', 'stone', 'stone_path', 'river', 'lake', 'mountain', 'ruins', 'cave', 'bridge'], description: 'Put your hands to work for the sage', karmaEffect: 8, needsSage: true },
  { id: 'walk', label: 'Walk With', tileTypes: ['grass', 'clearing', 'stone_path', 'sand', 'beach', 'forest', 'tall_grass', 'grove', 'garden', 'flower'], description: 'Walk alongside in quiet companionship', karmaEffect: 2, needsSage: true },
  { id: 'silent', label: 'Be Silent', tileTypes: ['grass', 'clearing', 'temple', 'shrine', 'grove', 'hut', 'village', 'garden', 'flower', 'forest', 'tall_grass', 'sand', 'beach', 'stone', 'stone_path', 'river', 'lake', 'mountain', 'ruins', 'cave', 'bridge'], description: 'Offer the gift of wordless presence', karmaEffect: 2, needsSage: true },
